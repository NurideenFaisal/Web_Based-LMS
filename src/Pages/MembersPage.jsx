    ...
    <div>
        ...
        <div className="relative z-10">
          ...
          <div className="flex items-center justify-between mb-8">
            <div className="flex-1">
              ...
              <p className="text-indigo-100 mb-4">Manage your library members and their accounts</p>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-6 mb-8">
        <div className="flex flex-col md:flex-row gap-4">
          ...
          <select className="px-4 py-3 bg-slate-50 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all">
          ...
          <table className="w-full">
            <thead>
              <tr className="bg-gradient-to-r from-indigo-500 to-purple-600 text-white">
                <th className="text-left py-4 px-6 font-semibold">
                  <button onClick={() => handleSort('memberId')} className="flex items-center gap-2 hover:text-indigo-100 transition-colors">
                    Member ID
                    <ArrowUpDown size={16} />
                  </button>
                </th>
                <th className="text-left py-4 px-6 font-semibold">
                  <button onClick={() => handleSort('name')} className="flex items-center gap-2 hover:text-indigo-100 transition-colors">
                    Name
                    <ArrowUpDown size={16} />
                  </button>
                </th>
                <th className="text-left py-4 px-6 font-semibold">
                  <button onClick={() => handleSort('email')} className="flex items-center gap-2 hover:text-indigo-100 transition-colors">
                    Email
                    <ArrowUpDown size={16} />
                  </button>
                </th>
                <th className="text-left py-4 px-6 font-semibold">
                  <button onClick={() => handleSort('phone')} className="flex items-center gap-2 hover:text-indigo-100 transition-colors">
                    Phone
                    <ArrowUpDown size={16} />
                  </button>
                </th>
                <th className="text-left py-4 px-6 font-semibold">
                  <button onClick={() => handleSort('memberType')} className="flex items-center gap-2 hover:text-indigo-100 transition-colors">
                    Type
                    <ArrowUpDown size={16} />
                  </button>
                </th>
                <th className="text-left py-4 px-6 font-semibold">
                  <button onClick={() => handleSort('joinDate')} className="flex items-center gap-2 hover:text-indigo-100 transition-colors">
                    Join Date
                    <ArrowUpDown size={16} />
                  </button>
                </th>
                <th className="text-center py-4 px-6 font-semibold">
                  <button onClick={() => handleSort('booksBorrowed')} className="flex items-center gap-2 hover:text-indigo-100 transition-colors mx-auto">
                    Borrowed
                    <ArrowUpDown size={16} />
                  </button>
                </th>
                <th className="text-left py-4 px-6 font-semibold">
                  <button onClick={() => handleSort('expiryDate')} className="flex items-center gap-2 hover:text-indigo-100 transition-colors">
                    Expiry
                    <ArrowUpDown size={16} />
                  </button>
                </th>
            ...
            <tbody>
              {members.map((member, index) => (
                <tr 
                  key={member.id} 
                  className={`border-b border-slate-100 transition-all hover:bg-gradient-to-r hover:from-indigo-50 hover:to-purple-50 ${
                    index % 2 === 0 ? 'bg-white' : 'bg-slate-50'
                  }`}
                >
                  <td className="py-5 px-6">
                    <div className="w-14 h-10 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-lg flex items-center justify-center text-white font-bold shadow-md text-sm">
                      {member.memberId}
                    </div>
                  </td>
                  <td className="py-5 px-6">
                  ...
                  <td className="py-5 px-6 text-center">
                    <span className={`text-lg font-bold ${member.booksBorrowed > 0 ? 'text-indigo-600' : 'text-slate-400'}`}>
                  ...
                  <td className="py-5 px-6">
                    <div className="flex items-center justify-center gap-2">
                      ...
                      <button className="p-2.5 bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white rounded-lg transition-all transform hover:-translate-y-0.5 hover:shadow-lg">
                        <Edit2 size={16} />
                      </button>
                      <button className="p-2.5 bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 text-white rounded-lg transition-all transform hover:-translate-y-0.5 hover:shadow-lg">
                        <Mail size={16} />
                      </button>
      ...
      <div className="mt-8 flex items-center justify-between bg-white rounded-2xl shadow-lg p-6">
        <div className="text-sm text-slate-600">
          Showing <span className="font-semibold text-indigo-600">1-5</span> of <span className="font-semibold text-indigo-600">3,847</span> members
        </div>
